...
$query_oldpassword = $con->query("SELECT * FROM admin WHERE password = '$encoded_oldpassword'");
...
$query_change_password = $con->query("UPDATE admin SET password = '$encoded_password' WHERE username = '$username'");
