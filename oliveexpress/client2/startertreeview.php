        ...
        <div class="content mt-3" >
              ...
              <div class="row" >
                    <div class="col-lg-12" style='background-Color:white;'>
                       <h3 class="page-header"><center>Chick Tree </center></h3>
								<div class="container" >
			<div class="row">
...
echo"<div class='panel-body' Style='width:100%; height:400px; overflow:scroll'>";
	...
	if($userstatus == 1){
			...
			echo"<center><table><tr><td style=''><center><img src='../images/user.png'><b><br></b>$id</span><br><img src='../images/line.png'></td></center></tr></table></center>";
			...
			if($id != "not"){
				...
				$reach++;
								...
								$check_when_to_call_leve1++;
									...
									echo"<td ><center><img src='../images/user.png'><b><br></b>$i</span><br><img src='../images/lines.png'></center></td>";
								}
...
echo"</tr></table></center>";
	...
	function restvariables() /////////////this function rests the variables before starting a new genealogy
	{
